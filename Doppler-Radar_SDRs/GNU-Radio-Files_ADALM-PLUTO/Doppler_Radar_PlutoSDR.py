...
import Doppler_Radar_PlutoSDR_calibration_module as calibration_module  # embedded python module
import Doppler_Radar_PlutoSDR_frequency_detector as frequency_detector  # embedded python module
import sip
import threading
import time
...
class Doppler_Radar_PlutoSDR(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Doppler_Radar_PlutoSDR", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Doppler_Radar_PlutoSDR")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Doppler_Radar_PlutoSDR")
...
def main(top_block_cls=Doppler_Radar_PlutoSDR, options=None):
